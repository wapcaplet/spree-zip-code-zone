...
desc 'Generate documentation for the zip_code_zone extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ZipCodeZoneExtension'
...
desc 'Test the zip_code_zone extension.'
...
namespace :test do
  desc 'Functional test the zip_code_zone extension.'
  ...
  desc 'Unit test the zip_code_zone extension.'
